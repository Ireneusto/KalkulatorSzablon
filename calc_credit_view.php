	...
	<div class="container">
		<div class="dropdown">
			...
			<ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
				...
				<li><a href="#about">Inna strona</a></li>
			</ul>
		</div>
	</div>
</nav>
    ...
    <div class="container">
        ...
        if (isset($errorMessages)) {
            if (count($errorMessages) > 0) {
                echo '<ol style="margin: 20px; padding: 10px 10px 10px 30px; border-radius: 5px; background-color: #eba434; width:300px;">';
        ...
        if (isset($result)) {
            echo '<div style="margin: 20px; padding: 10px; border-radius: 5px; background-color: #34d9eb; width:300px;">';
            echo 'Wysokość miesięcznej raty: '.round($result, 2).'zł';
            echo '</div>';
        }
        ?>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-10 col-lg-10 col-md-offset-1 col-lg-offset-1 text-center">
                ...
                <h1 class="title">To jest inna strona tego szablonu.</h1>
